      ...
      array(
        ...
        'events' => array(
          ...
          array(
            ...
            'title' => $this->wp->__('Big Spender', 'mailpoet'),
            'description' => $this->wp->__('Let MailPoet send an email to customers who have spent a certain amount to thank them, possibly with a coupon.', 'mailpoet'),
            'soon' => true,
            'badge' => array(
              'text' => $this->wp->__('Smart to have', 'mailpoet'),
              'style' => 'teal'
            )
          ),
          array(
